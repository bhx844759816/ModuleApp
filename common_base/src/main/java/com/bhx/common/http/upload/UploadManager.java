...
public class UploadManager {
    ...
    public static void uploadFile(String url, @NotNull List<UploadParam> params, UploadProgressObserver<ResponseBody> observer) {
    ...
    public static void uploadFile(String url, @NotNull List<UploadParam> params, Observer<ResponseBody> observer) {
        ApiService apiService = RetrofitManager.getInstance().createApiService(ApiService.class);
        List<MultipartBody.Part> paramList = new ArrayList<>();
        for (UploadParam param : params) {
            switch (param.getType()) {
